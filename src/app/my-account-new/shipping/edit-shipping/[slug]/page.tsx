...
const EditShipping: React.FC = ({ searchParams }: { params: { slug: string }, searchParams: any }) => {
  ...
  const [shippingData, setShippingData] = useState<FormData>({
    shipping_first_name: searchParams.shipping_first_name || '',
    shipping_last_name: searchParams.shipping_last_name || '',
    shipping_address_1: searchParams.shipping_address_1 || '',
    shipping_address_2: searchParams.shipping_address_2 || '',
    shipping_city: searchParams.shipping_city || '',
    shipping_state: searchParams.shipping_state || '',
    shipping_postcode: searchParams.shipping_postcode || '',
    shipping_company_name: searchParams.shipping_company_name || '',
    shipping_country: searchParams.shipping_country || '',
    extra_info: searchParams.extra_info || '',
    id: searchParams.id || '',
  ...
  const handleSubmit = async () => {
    const { id, shipping_first_name, shipping_last_name, shipping_address_1, shipping_address_2, shipping_city, shipping_company_name, shipping_state, shipping_postcode, shipping_country } = shippingData as Required<FormData>;
