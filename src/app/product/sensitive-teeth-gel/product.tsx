...
const requestData = {
  productIds: ['130248', '130247', '130246'],
  selectedFields: [
    'id',
    'name',
    'price',
...
export default async function Product() {
  ...
  return (
    <div className='whiening_gel_products' id="desensitizing-gel-wrapper">
      <Container>
        <Row id="products">
                ...
                <div className="product-selection-price-wrap">
                  <div>
                    ...
                    <div className="value-text text-center">
                      {index == 0
                        ? 'Avg Dentist Price: $135+'
                        : index == 1
                          ? 'Avg Dentist Price: $90+'
                          : 'Avg Dentist Price: $45+'}
                    </div>
                  </div>
                  <div className="value-text text-center">
                    {product?.innerTitle}
