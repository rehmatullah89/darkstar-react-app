...
import styles from './enamelArmourProduct.module.css';
import Image from 'next/image';
import { FontAwesomeIcon } from '@fortawesome/react-fontawesome';
import { faDollarSign } from '@fortawesome/free-solid-svg-icons';

interface enamelArmourProductProps {
  title?: string;
  priceNote?: any;
  price?: string;
  ValueText?: any;
...
export default function EnamelArmourProduct({
  title,
  priceNote,
  price,
  ValueText,
