...
import styles from './retainerCleanerProduct.module.css';
import Image from 'next/image';
import { FontAwesomeIcon } from '@fortawesome/react-fontawesome';
import { faDollarSign } from '@fortawesome/free-solid-svg-icons';

interface retainerCleanerProductProps {
  title?: string;
  priceNote?: any;
  price?: string;
  ValueText?: any;
...
export default function RetainCleanerProduct({
  title,
  priceNote,
  price,
  ValueText,
