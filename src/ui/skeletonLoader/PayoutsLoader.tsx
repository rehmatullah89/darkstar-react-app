      ...
      {payouts.map((item, idx) => (
        <div key={idx}>
          ...
          <div style={{
            ...
            <div >
              <Skeleton width={isDesktop ? 320 : 150} baseColor={idx % 2 !== 0 ? COLORS.gray : COLORS.grayLight} />
            </div>
            <div >
              <Skeleton width={isDesktop ? 300 : 150} baseColor={idx % 2 !== 0 ? COLORS.grayLight : ''} />
            </div>
          </div>
        </div>
      ))}
